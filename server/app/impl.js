 ...
 */
// IMPORTANT: USE `globalThis`!!!
globalThis.___FRAMEWORK_JS_STRINGIFY___ = (item, toCreate) => {
 ...
 */
globalThis.___FRAMEWORK_JS_STYLE_NAME___ = (name) => {
 ...
 */
globalThis.___FRAMEWORK_JS_STYLE_VALUE___ = (styleValue, styleName) => {
